package com.github.chenzm77.user.trigger.rpc;
...
import com.github.chenzm77.user.app.user.UserApplicationService;
...
public class UserServiceRpc implements IUserService {
    ...
    @Override
    public UserResponseDTO createUserByPhone(String phone) {
        UserEntity user = userApplicationService.createUserByPhone(phone);
        return toUserDTO(user);
    }
